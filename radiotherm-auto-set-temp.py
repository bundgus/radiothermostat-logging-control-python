...
def get_target_temp_heating(tstat, story=None):
    ...
    if story is 1:
        # between 5 am and 10 pm turn up the heat downstairs
        if 5 < hour_of_day <= 7:
            return 72
    ...
    try:
        ...
        while True:
            ...
            if tstat1.tmode['human'] == 'Cool' and tstat1.t_cool['raw'] < target_cool_temp_1:
                ...
                print(now, 'heat 1 set to more than ' + str(target_heat_temp_1) + ' for '
            ...
            elif tstat2.tmode['human'] == 'Heat' and tstat2.t_heat['raw'] > target_heat_temp_2:
                print(now, 'heat 2 set to more than ' + str(target_heat_temp_2) + ' for '
